...
<ol>
  ...
  <li>Once the project folder is in the <code>htdocs</code> folder and the database is created, you can access the website by typing <code>file:///C:/xampp/htdocs/how_to_be_fine(z)/index.html</code> in your web browser.</li>
